...
requestfile_ratio: float = 15.10924  # Ratio of requests in sample frame over base demand
demand_ratio: float = 0.5 #1.252 #1.252 = survey volume  # 1.0 = original Decell dataset volume # this is for convenient scaling
