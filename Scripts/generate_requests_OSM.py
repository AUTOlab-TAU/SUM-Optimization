...
inpath = os.path.join(PROJECT_ROOT, "JerusalemData", "demand", "Processed")
nodes_df = pd.read_csv(os.path.join(inpath, "fleetpy_node_taz.csv"))
...
ods = convert_od_file_to_dict(os.path.join(inpath, "weekday_top15_hourly.csv"))
requests = {}
...
df.to_csv(os.path.join(inpath, "requests_fleetpy_nodes_with_nsm_7am9am_scale30x.csv"), index=False)
